...
const FormTribeca = () => {
  ...
  return (
    <div id="form" className="w-full flex flex-col justify-center items-start py-4">
      ...
      <div className="mb-4">
        <p className="text-gray-700">
          <strong>Release and Waiver:</strong> I hereby release, discharge, and waive any claims against Action Black Tribeca LLC, agreeing not to initiate any legal proceedings.
        </p>
      </div>
